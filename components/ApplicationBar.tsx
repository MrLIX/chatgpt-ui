      ...
      >
        ...
        <MenuItem>
          ...
          <Switch
            ...
            onChange={handleSystemMessagesToggle}
            sx={{ ml: "auto" }}
          />
        </MenuItem>
