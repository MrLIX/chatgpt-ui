...
export function SettingsModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  const handleApiHostChange = (e: React.ChangeEvent) =>
    setApiHost((e.target as HTMLInputElement).value);

  const handleApiOrganizationIdChange = (e: React.ChangeEvent) =>
    setApiOrganizationId((e.target as HTMLInputElement).value);
  ...
  const handleMaxTokensChange = (event: Event, newValue: number | number[]) =>
    setModelMaxResponseTokens(newValue as number);
          ...
          <Section>
            <Stack direction="column" sx={{ gap: 3, maxWidth: 400 }}>
              <FormControl
                ...
                sx={{ ...hideOnMobile, alignItems: "center", justifyContent: "space-between" }}
              >
                <Box>
                ...
                >
                  <Radio
                    value="narrow"
                    label={<WidthNormalIcon sx={{ width: 25, height: 24, mt: -0.25 }} />}
                  />
                  <Radio
                    value="wide"
                    label={<WidthWideIcon sx={{ width: 25, height: 24, mt: -0.25 }} />}
                  />
              ...
              >
                <Box>
                  ...
                  <FormHelperText>
                    {zenMode === "clean" ? "Show senders" : "Hide sender and menus"}
                  </FormHelperText>
                </Box>
              ...
              <FormControl orientation="horizontal" sx={{ justifyContent: "space-between" }}>
                <Box>
                  ...
                  <FormHelperText>
                    {renderMarkdown ? "Render markdown" : "Text only"}
                  </FormHelperText>
                </Box>
                <Switch
              ...
              <FormControl orientation="horizontal" sx={{ justifyContent: "space-between" }}>
                <Box>
                  ...
                  <FormHelperText>
                    {showPurposeFinder ? "Show search bar" : "Hide search bar"}
                  </FormHelperText>
                </Box>
                <Switch
            ...
            <Stack direction="column" sx={{ gap: 3, mt: -0.8, maxWidth: 400 }}>
              <FormControl orientation="horizontal" sx={{ justifyContent: "space-between" }}>
                <Box sx={{ minWidth: 130 }}>
                  ...
                  <FormHelperText>
                    {modelTemperature < 0.33
                      ? "More strict"
                      : modelTemperature > 0.67
                      ? "Larger freedom"
                      : "Creativity"}
                  </FormHelperText>
                </Box>
              ...
              <FormControl orientation="horizontal" sx={{ justifyContent: "space-between" }}>
                <Box sx={{ minWidth: 130 }}>
                  ...
                  <FormHelperText sx={{ display: "block" }}>
                    <Link
                      level="body2"
                      href="https://github.com/enricoros/nextjs-chatgpt-app/issues/63"
                      target="_blank"
                    >
                      What is this
                    </Link>
